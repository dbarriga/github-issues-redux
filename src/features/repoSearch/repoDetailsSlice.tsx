...
const repoDetails = createSlice({
  ...
  reducers: {
    ...
    getRepoDetailsFail(state, action: PayloadAction<string>) {
...
export const {getRepoDetailsSuccess, getRepoDetailsFail} = repoDetails.actions;
...
export const fetchIssuesCount = (org: string, repo: string): AppThunk => async dispatch => {
  try {
    ...
    dispatch(getRepoDetailsFail(err.toString()))
  }
}